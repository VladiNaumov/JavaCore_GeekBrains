package naumDeveloper.more.testirovanie_upiter.test.java.HomeWork;
...
public class ArrListTest {
    ...
    void shouldFindNumbersAfterLastFourAtArray(int[] expected, int[] array) {
        Assertions.assertArrayEquals(expected, ArrList.findNumbersAfterLastFourAtArray(array));
    }
    ...
    void shouldThrowRuntimeExceptionInMyArraysFindNumbersAfterLastFourAtArray() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            ArrList.findNumbersAfterLastFourAtArray(new int[]{3, 2, 3, 7, 1});
        });
    }
    ...
    void shouldCheckArrayForOneAndFour(boolean expected, int[] array) {
        Assertions.assertEquals(expected, ArrList.checkArrayForOneAndFour(array));
    }
